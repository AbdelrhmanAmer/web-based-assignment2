...
<?php $__env->startSection('links'); ?>
    <li><a class="dropdown-item text-light" href="<?php echo e(url('/en/login')); ?>"><?php echo e(__('messages.english')); ?></a></li>
    <li><a class="dropdown-item text-light" href="<?php echo e(url('/ar/login')); ?>"><?php echo e(__('messages.arabic')); ?></a></li>
